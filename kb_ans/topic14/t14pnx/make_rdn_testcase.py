...
def main(file_name, case_cnt, block_path_ratio):
    ...
    with open(file_name, 'w') as f:
        a = random.randrange(0, 2 * 10**1) - 10**1
        b = random.randrange(0, 2 * 10**1) - 10**1
        c = random.randrange(0, 2 * 10**1) - 10**1
        x1 = random.randrange(0, 2 * 10**1) - 10**1
        x2 = random.randrange(0, 2 * 10**1) - 10**1
        y1 = random.randrange(0, 2 * 10**1) - 10**1
        y2 = random.randrange(0, 2 * 10**1) - 10**1
        f.write("{} {} {}\n{} {}\n{} {}\n".format(a, b, c, x1, x2, y1, y2))
